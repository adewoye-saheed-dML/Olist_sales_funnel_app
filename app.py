...
def clean_data(uploaded_files=None):
    ...
    mql_url   = st.secrets.get("MQL_URL",   "https://github.com/adewoye-saheed-dML/Olist_sales_funnel_app/blob/main/olist_marketing_qualified_leads_dataset.csv")
    cld_url   = st.secrets.get("CLD_URL",   "https://github.com/adewoye-saheed-dML/Olist_sales_funnel_app/blob/main/olist_closed_deals_dataset.csv")
    order_url = st.secrets.get("ORDER_URL", "https://github.com/adewoye-saheed-dML/Olist_sales_funnel_app/blob/main/olist_orders_dataset.csv")
    ...
    for file_or_url in uploaded_files:
        # pd.read_csv works on both file‑like and URL strings
